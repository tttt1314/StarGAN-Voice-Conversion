...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_spk', type=str, default='chest', help = 'target speaker.') #MODIFY
    parser.add_argument('--trg_spk', type=str, default='falset', help = 'target speaker.') #MODIFY
